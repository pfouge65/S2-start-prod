<template>
  <el-row>
    ...
    <el-col :xs="12" :span="9" :lg="6" class="actions">
      ...
      <el-button v-if="isTaskInProgress" @click="stopTask" type="danger" icon="el-icon-video-pause" circle></el-button>
    </el-col>
...
<script>
  ...
  methods:{
    startTask () {
      // console.log('startTask', this.taskname)
      // Vérifications
